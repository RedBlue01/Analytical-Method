...
from keras.layers import Input, Dense, Dropout, LeakyReLU, BatchNormalization, Flatten, Embedding, multiply
from keras.initializers import Adam, RandomNormal
        ...
        for epoch in range(epochs):
            ...
            if plot:
                if epoch+1==epochs:
                    ...
                    plt.legend()
                    # plt.show()
                    plt.savefig('/home/visitor/Huang/Analytical-Method/GAN/CGAN/fig1.png')